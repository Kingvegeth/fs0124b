...
public class AppConfig {
	...
	@Bean("Tavolo1")
	public Table table1Bean(){ return new Table(1,5,TableStatus.AVAILABLE); }
	@Bean("Tavolo2")
	public Table table2Bean(){ return new Table(2,6,TableStatus.AVAILABLE); }
	@Bean("Tavolo3")
	public Table table3Bean(){ return new Table(3,4,TableStatus.AVAILABLE); }


//	@Bean(name = "order1")
//	public Order menuOrder(){
//		List<Item> orderList = new ArrayList<>();
//
//		orderList.add(pizzaSalamiBean());
//		orderList.add(pizzaHawaiianBean());
//		orderList.add(wineBean());
//		orderList.add(lemonadeBean());
//
//		return new Order(1,orderList,2);
//	}
