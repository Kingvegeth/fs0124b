...
/*for (let i = 0; i < starWarsCharacters.length; i++) {
  for (let j = 0; j < femaleCharacters.length; j++) {
    let nomef=femaleCharacters[j].name
    let nome=starWarsCharacters[i].name
   if (nomef===nome) {
...
function randomCharacter() {
  let character = Math.floor(Math.random()*starWarsCharacters.length)
  console.log("Hi, my name is",starWarsCharacters[character].name,"and I'm a",starWarsCharacters[character].height,"cm tall",starWarsCharacters[character].gender);
}
randomCharacter()